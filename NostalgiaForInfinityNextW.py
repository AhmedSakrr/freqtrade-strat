...
class NostalgiaForInfinityNextW(IStrategy):
    INTERFACE_VERSION = 2
    ...
    def whitelist_tracker(self):
        if sorted(self.coin_metrics["current_whitelist"]) != sorted(
    ...
    def top_traded_list(self):
        ...
        column_names = [
            f"Coin #{i}" for i in range(1, self.coin_metrics["top_traded_len"] + 1)
        ]
        self.coin_metrics["tt_dataframe"][column_names] = self.coin_metrics[
            "tt_dataframe"
        ].apply(
        ...
        self.coin_metrics["tt_dataframe"].drop(
            columns=[
                col
                for col in self.coin_metrics["tt_dataframe"]
    ...
    def top_grossing_list(self):
        ...
        self.coin_metrics["tg_dataframe"][column_names] = self.coin_metrics[
            "tg_dataframe"
        ].apply(
        ...
        self.coin_metrics["tg_dataframe"].drop(
            columns=[
                col
                for col in self.coin_metrics["tg_dataframe"]
                if col not in column_names
            ],
            inplace=True,
        )
    ...
    def is_top_coin(self, coin_pair, row_data, top_length) -> bool:
        return (
            coin_pair.split("/")[0]
            in row_data.loc["Coin #1":f"Coin #{top_length}"].values
        )
    ...
    def bot_loop_start(self, **kwargs) -> None:
        ...
        if (
            self.coin_metrics["top_traded_enabled"]
            or self.coin_metrics["top_grossing_enabled"]
        ):
            self.whitelist_tracker()
        if (
            self.coin_metrics["top_traded_enabled"]
            and not self.coin_metrics["top_traded_updated"]
        ):
    ...
    def sell_stoploss(
        ...
        if (
            ...
            return True, "sell_hopeless_coin"
        ...
        if (
            ...
            return True, "sell_hopeless_coin_2"
    ...
    def sell_long_mode(
        ...
        # Sell signal 7
        elif (last_candle["rsi_14_1h"] > 82.0) and (
    ...
    def custom_sell(
        ...
        **kwargs,
        ...
        # Quick sell mode
        if all(
            c in ["empty", "32", "33", "34", "35", "36", "37", "38", "40"]
            for c in buy_tags
        ):
    ...
    def informative_1d_indicators(
        ...
        if self.coin_metrics["top_grossing_enabled"]:
            ...
            column_names = [
                f"Coin #{i}"
                for i in range(1, self.coin_metrics["top_grossing_len"] + 1)
            ]
            informative_1d.drop(columns=column_names, inplace=True)
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params[f"buy_condition_{index}_enable"]:
                ...
                # Condition #20
                    ...
                    item_buy_logic.append(
                        dataframe["rsi_14_1h"] < self.buy_20_rsi_14_1h_max
                    )
                    item_buy_logic.append(dataframe["cti"] < self.buy_20_cti_max)
                    item_buy_logic.append(
                        dataframe["volume"]
                        < (dataframe["volume_mean_4"] * self.buy_20_volume)
                    )
                ...
                # Condition #21
                    ...
                    item_buy_logic.append(
                        dataframe["rsi_14_1h"] < self.buy_21_rsi_14_1h_max
                    )
                    item_buy_logic.append(dataframe["cti"] < self.buy_21_cti_max)
                    item_buy_logic.append(
                        dataframe["volume"]
                        < (dataframe["volume_mean_4"] * self.buy_21_volume)
                    )
                ...
                # Condition #23
                    ...
                    item_buy_logic.append(
                        dataframe["rsi_14_1h"] < self.buy_23_rsi_14_1h_max
                    )
                    item_buy_logic.append(
                        dataframe["r_480_1h"] > self.buy_23_r_480_1h_min
                    )
                ...
                # Condition #25
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_15"] * self.buy_25_ma_offset
                    )
                ...
                # Condition #32 - Quick mode buy
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_15"] * self.buy_32_ma_offset
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["crsi_1h"] < self.buy_32_crsi_1h_max
                    )
                ...
                # Condition #37 - Quick mode buy
                    ...
                    item_buy_logic.append(
                        dataframe["crsi_1h"] > self.buy_37_crsi_1h_min
                    )
                    item_buy_logic.append(
                        dataframe["crsi_1h"] < self.buy_37_crsi_1h_max
                    )
                ...
                # Condition #38 - PMAX3 buy
                    ...
                    item_buy_logic.append(
                        dataframe["crsi_1h"] > self.buy_38_crsi_1h_min
                    )
                ...
                # Condition #41
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_41_ewo_1h_min
                    )
                    item_buy_logic.append(
                        dataframe["r_480_1h"] < self.buy_41_r_480_1h_max
                    )
                    item_buy_logic.append(
                ...
                # Condition #42
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_42_ewo_1h_min
                    )
                    item_buy_logic.append(dataframe["cti_1h"] > self.buy_42_cti_1h_min)
                    item_buy_logic.append(
                        dataframe["r_480_1h"] < self.buy_42_r_480_1h_max
                    )
                ...
                # Condition #44
                    ...
                    item_buy_logic.append(
                        dataframe["crsi_1h"] > self.buy_44_crsi_1h_min
                    )
                ...
                # Condition #45 - Long mode
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_45_ewo_1h_min
                    )
                    item_buy_logic.append(dataframe["cti_1h"] < self.buy_45_cti_1h_max)
                    item_buy_logic.append(
                        dataframe["r_480_1h"] < self.buy_45_r_480_1h_max
                    )
                ...
                # Condition #46 - Long mode
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_46_ewo_1h_min
                    )
                ...
                # Condition #47 - Long mode
                    ...
                    item_buy_logic.append(
                        dataframe["close"]
                        < (dataframe["sma_30"] * self.buy_47_ma_offset)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_47_ewo_1h_min
                    )
                ...
                # Condition #48 - Uptrend mode
                    ...
                    item_buy_logic.append(
                        dataframe["ewo_sma_1h"] > self.buy_48_ewo_1h_min
                    )
                    item_buy_logic.append(dataframe["r_480"] > self.buy_48_r_480_min)
                    item_buy_logic.append(
                        dataframe["r_480_1h"] > self.buy_48_r_480_1h_min
                    )
                    item_buy_logic.append(
                        dataframe["r_480_1h"] < self.buy_48_r_480_1h_max
                    )
                    item_buy_logic.append(
